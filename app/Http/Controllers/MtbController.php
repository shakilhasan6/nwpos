...
class MtbController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('layout.mtb', compact('data'));
    }
    ...
    public function store(Request $request)
    {
        ...
        MtbData::create($request->only(['tid','mid','merchent','address','officer','number','pos_s']) + ['user_id' => auth()->id()]);
    ...
    public function update(Request $request, $id)
{
    ...
    if ((!auth()->user()->isAdmin() && !auth()->user()->isMtbManager()) && $data->user_id && $data->user_id != auth()->id()) {
    ...
    return redirect()->route('mtb.index')->with('success', 'Data Updated Successfully!');
}
    ...
    public function import(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('mtb.index')
                ->with('success', "$imported records imported successfully!");

        } catch (\Throwable $e) {

            Log::error('Mtb import error', [
