...
class CblController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('layout.cbl', compact('data'));
    }
    ...
    public function store(Request $request)
    {
        ...
        CblData::create($request->only(['tid','mid','merchent','address','officer','number','pos_s']) + ['user_id' => auth()->id()]);
    ...
    public function update(Request $request, $id)
{
    ...
    if ((!auth()->user()->isAdmin() && !auth()->user()->isCtManager()) && $data->user_id && $data->user_id != auth()->id()) {
    ...
    return redirect()->route('cbl.index')->with('success', 'Data Updated Successfully!');
}
    ...
    public function import(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('cbl.index')
                ->with('success', "$imported records imported successfully!");

        } catch (\Throwable $e) {

            Log::error('Cbl import error', [
